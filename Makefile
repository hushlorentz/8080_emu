...
TEST_SPECIFIC_OBJ = $(addprefix $(TEST_OBJ_DIR)/, accumulator.o bit_operations.o bootstrap.o data_transfer.o op_codes.o pair_register.o rotate.o single_register.o)
