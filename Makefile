...
TEST_SPECIFIC_OBJ = $(addprefix $(TEST_OBJ_DIR)/, accumulator.o bit_operations.o bootstrap.o call.o data_transfer.o direct.o jump.o immediate.o operations.o op_codes.o pair_register.o return.o rotate.o single_register.o)
